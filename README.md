...
## 안녕하세요, 일상에 작은 따뜻함을 더하는 개발을 꿈꾸는 강종민입니다!

복지관에서 대체복무를 하며, 저는 어르신들이 디지털 환경에서 겪는 불편함을 직접 마주했습니다.

이 경험은 저에게 **“편리하고, 실질적인 도움을 줄 수 있는 프로그램을 만들고 싶다”** 는 마음을 심어주었습니다.

그 이후로 저는 복지 분야에 특화된 다양한 프로그램들을 개발해왔습니다.

개발을 진행하며 깨달은 점은 분명했습니다.
기술은 누군가의 일상을 바꿀 수 있고, 그 변화는 행복으로 이어진다는 사실입니다.
작은 개선이 실제 사용자에게 전달되는 순간, 개발자로서의 보람과 방향성을 확신하게 되었습니다.

현재 저는 클라우드 · 보안 · AI 기술을 중심으로 학습을 이어가고 있습니다.
그리고 기술이 단순히 기능을 넘어서,
**사람에게 닿고 마음을 움직이는 ‘따뜻한 기술’** 이 되길 바라는 마음으로 성장하고 있습니다.
☁️🌿
